...
if (isset($_GET['search_btn'])) {
   $hampers = $_GET['hampers'];
   $search_hampers = read("SELECT * FROM produk WHERE nama_produk LIKE '%$hampers%';");
}
...
<body class="image-bg">
   ...
   <div class="container-main content">
         ...
         <div class="col-md-12">
            <div class="search-container">
               <form action="" method="GET">
                  ...
                  <input type="text" placeholder="Temukan hampersmu.." name="hampers" class="form-control" autocomplete="off">
               </form>
            </div>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-9">
            <?php if (isset($_GET['hampers']) && $_GET['hampers'] != '') : ?>
               <?php foreach ($search_hampers as $data) : ?>
                  <!-- <a class="sub-title" href="marchendise?kategori=<?= $data['kategori'] ?>"><?= $data['kategori'] ?></a> -->
                  <div class="main-category">
                     <div class="produk d-flex active">
